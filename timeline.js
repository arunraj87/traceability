(function(){
    ...
    $.fn.timeline =function(data, opts){
        ...
        data.forEach(function(value, index){
            ...
            tempateToParse = tempateToParse.replace(/##index##/g, index);
            ...
            tempateToParse = tempateToParse.replace(/##status-completed##/g, value.completed ? 'status-completed':'');
    ...
    var getTemplate = function () {
        ...
        var statusTemplate = '<div class="link">' +
                                '<div class="status status-transition top-content ##status-completed##" style="transition-delay:##index##s">' +
                                    '<span>##status##</span>' +
                                '</div>' +
                                ...
                                '<div class="status status-transition ##status-completed##" style="transition-delay:##index##s">' +
                                    '<span>##date##</span>' +
                                '</div>' +
                                '<div class="status status-transition ##status-completed##" style="transition-delay:##index##s">' +
                                    '<span>##comment##</span>' +
